            ...
            <Table>
              <TableHeader className="bg-surface-container-low">
                <TableRow className="border-b border-outline-variant/40 hover:bg-transparent">
                  <TableHead className="font-headline text-xs font-bold uppercase text-on-surface-variant w-28">
                    Mã đơn
                  </TableHead>
                  ...
                  <TableHead className="font-headline text-xs font-bold uppercase text-on-surface-variant text-center w-28">
                    Chi tiết
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody className="font-medium text-xs text-on-surface-variant divide-y divide-outline-variant/40">
                {orders.length === 0 ? (
                  ...
                  orders.map((order) => (
                    ...
                    >
                      <TableCell className="py-4 font-mono text-primary font-bold text-xs">
                        {order.id}
                      </TableCell>
                      <TableCell className="py-4">
                        <div className="flex flex-col text-left">
                          ...
                          <span className="text-[10px] mt-0.5 text-on-surface-variant">
                            {order.customerPhone}
                          </span>
                        </div>
                      </TableCell>
