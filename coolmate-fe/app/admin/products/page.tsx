          ...
          <div className="flex justify-between items-center mb-8 border-b border-outline-variant/30 pb-5">
            <div>
              ...
              <p className="text-xs text-on-surface-variant font-medium mt-1">
                Admin console / Dữ liệu từ NovaWear API
              </p>
            </div>
            ...
            <Table>
              <TableHeader className="bg-surface-container-low">
                <TableRow className="border-b border-outline-variant/40 hover:bg-transparent">
                  <TableHead className="font-headline text-xs font-bold uppercase text-on-surface-variant w-16">
                    Ảnh
                  </TableHead>
                  <TableHead className="font-headline text-xs font-bold uppercase text-on-surface-variant">
                    Tên sản phẩm
                  </TableHead>
                  <TableHead className="font-headline text-xs font-bold uppercase text-on-surface-variant">
                    Danh mục
                  </TableHead>
                  <TableHead className="font-headline text-xs font-bold uppercase text-on-surface-variant text-right">
                    Giá bán
                  </TableHead>
                  <TableHead className="font-headline text-xs font-bold uppercase text-on-surface-variant text-right">
                    Tồn kho
                  </TableHead>
                  <TableHead className="font-headline text-xs font-bold uppercase text-on-surface-variant text-center w-32">
                    Thao tác
                  </TableHead>
                </TableRow>
              </TableHeader>
                    ...
                    >
                      <TableCell className="py-3">
                        <OptimizedImage
                          ...
                          height={48}
                          sizes="40px"
                          className="h-12 w-10 rounded bg-surface-container-low object-cover"
                        />
                      </TableCell>
                      <TableCell className="py-3">
                      ...
                      <TableCell className="py-3 text-right font-bold text-on-surface">
                      ...
                      <TableCell className="py-3 text-right">
                        {product.stock <= 10 ? (
                          <Badge
                            variant="destructive"
                            className="font-semibold text-[10px] py-0 px-1.5"
                          >
                        ...
                        <div className="flex items-center justify-center gap-2">
                          ...
                          >
                            <Button
                              variant="ghost"
                              size="icon"
                              className="h-8 w-8 hover:bg-surface-container text-primary cursor-pointer"
                            >
                          ...
                          <Button
                            ...
                            className="h-8 w-8 hover:bg-red-50 text-destructive cursor-pointer"
                            title="Xóa"
                          >
